...
namespace XRS_API.Migrations
{
    ...
    [Migration("20240609105827_updateSomeOfData")]
    partial class updateSomeOfData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XRS_API.Models.Employee", b =>
                {
                    b.HasOne("XRS_API.Models.Hotel", null)
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("XRS_API.Models.Payment", b =>
                {
                    b.HasOne("XRS_API.Models.Booking", null)
                        .WithMany("Payments")
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("XRS_API.Models.Guest", null)
                        .WithMany("Payments")
